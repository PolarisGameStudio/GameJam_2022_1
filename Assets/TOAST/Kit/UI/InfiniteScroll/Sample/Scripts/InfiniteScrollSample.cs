...
public class InfiniteScrollSample : MonoBehaviour
{
    ...
    private void MoveTo(int index)
    {
        ...
        {
            verticalScrollList.MoveTo(index, (InfiniteScroll.MoveToType)moveDataTypeSelect.value);
            horizontalScrollList.MoveTo(index, (InfiniteScroll.MoveToType)moveDataTypeSelect.value);
        }
        else
        {
            var data = dataList[index];

            verticalScrollList.MoveTo(data, (InfiniteScroll.MoveToType)moveDataTypeSelect.value);
            horizontalScrollList.MoveTo(data, (InfiniteScroll.MoveToType)moveDataTypeSelect.value);
        }
